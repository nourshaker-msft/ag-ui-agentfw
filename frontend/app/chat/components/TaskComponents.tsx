...
export const StepContainer = ({ theme, children }: { theme?: string; children: React.ReactNode }) => (
...
export const StepsFeedback = ({ args, respond, status }: { args: any; respond: any; status: any }) => {
